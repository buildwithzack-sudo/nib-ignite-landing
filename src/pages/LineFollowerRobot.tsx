...
import { ArrowLeft, Calendar, Users, Trophy, AlertCircle, Ruler, Battery } from "lucide-react";
import { Link } from "react-router-dom";
import { Button } from "@/components/ui/button";
import { Card } from "@/components/ui/card";

export default function LineFollowerRobot() {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Line Follower Robot <span className="text-gradient">(Path Finder)</span>
          </h1>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-12">
            ...
            <Card className="p-6">
              ...
              <p className="text-muted-foreground">Junior & Senior</p>
            </Card>
          </div>
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-primary pl-4">
                ...
                <p className="text-muted-foreground">
                  Teams present their Line Follower Robot at their School event.
                </p>
              </div>
          ...
          <Card className="p-8 mb-8">
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li className="flex items-start">
                ...
                Team has to use Wireless completely autonomous bots.
              </li>
              <li className="flex items-start">
                <span className="text-primary mr-2">•</span>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">The arena will be 6ft x 4ft approximately.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Arena will have some hurdles (like sharp turns, etc.).</p>
                </div>
              </div>
            </div>
          </Card>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-primary pl-4">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li>• Bot can be of at-most 3.5 Kg.</li>
